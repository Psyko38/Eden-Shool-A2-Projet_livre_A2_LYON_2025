...
- Importez le fichier `BDD/BDD.sql` dans PHPMyAdmin  
  *ou*
- Exécutez directement le script SQL via votre client MySQL
...
- Gestion des catégories :
    - Ajouter une ou plusieurs catégories à un livre
    - Supprimer ou modifier une ou plusieurs catégories d’un livre
...
Créer une base de donnée avec le nom `eval_livre`
...
## V2:
Un livre peut avoir plusieurs catégories (Policier, roman,...) et a un auteur
